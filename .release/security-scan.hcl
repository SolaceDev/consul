...
container {
	...
	triage {
		suppress {
			# SOLACE: CVE suppressions added by Solace for known false positives
			# These are primarily OpenSSL CVEs (2006-2024) and other container-related vulnerabilities
			vulnerabilities = [
				"CVE-2006-1174",
				"CVE-2007-4131",
				"CVE-2007-4476",
